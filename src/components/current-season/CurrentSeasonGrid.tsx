...
export const CurrentSeasonGrid = () => {
  ...
  // Fondo según temporada: S8 = Season8Wallpaper; S7 = Season7Wallpaper; resto = imagen anterior
  const isSeason8 = theme.seasonKey === "season8";
  const isSeason7 = theme.seasonKey === "season7";
  const isSeason9 = theme.seasonKey === "season9";
  ...
  return (
    <MainRootContainer
      ...
      background={isSeason8 || isSeason7 || isSeason9 ? "rgba(0, 0, 0, 0.25)" : "rgba(0, 0, 0, 0.3)"}
