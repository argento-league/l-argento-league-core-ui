...
export const UPPER_BRACKET_R2_MATCHES: Match[] = [
  ...
  },
  {
    ...
    child_count: 0,
    status: 0,
    opponent1: { id: 4, result: "win", score: 2 },
    opponent2: { id: 7, result: "loss", score: 1 },
  },
  {
    id: 10,
    number: 3,
    ...
    status: 0,
    opponent1: { id: 8, score: 2, result: "win" },
    opponent2: { id: 11, score: 0, result: "loss" },
  },
  {
    id: 11,
    number: 4,
    ...
    child_count: 0,
    status: 1,
    opponent1: { id: 12, result: "loss", score: 0 },
    opponent2: { id: 14, result: "win", score: 2 },
  },
];
...
export const UPPER_BRACKET_R3_MATCHES: Match[] = [
  {
    ...
    status: 0,
    opponent1: { id: 0, result: "win", score: 2 },
    opponent2: { id: 4, result: "loss", score: 0 },
  },
  {
    id: 13,
    number: 2,
    ...
    child_count: 0,
    status: 0,
    opponent1: { id: 8, result: "loss", score: 1 },
    opponent2: { id: 14, result: "win", score: 2 },
  },
];
...
export const UPPER_BRACKET_R4_MATCHES: Match[] = [
  {
    ...
    status: 0,
    opponent1: { id: 0, result: "win", score: 2 },
    opponent2: { id: 14, result: "loss", score: 0 },
  },
];
...
export const LOWER_BRACKET_R1_MATCHES: Match[] = [
  {
    ...
    child_count: 0,
    status: 0,
    opponent2: { id: 16, result: "win", score: 2 },
    opponent1: { id: 1, result: "loss", score: 0 },
  },
  {
    id: 16,
    number: 2,
    ...
    opponent2: { id: 17, score: 0, result: "loss" },
  },
  {
    id: 17,
    number: 3,
    ...
    opponent2: { id: 18, score: 0, result: "loss" },
  },
  {
    id: 18,
    number: 4,
  ...
  },
  {
    ...
    child_count: 0,
    status: 0,
    opponent1: { id: 9, score: 1, result: "loss" },
    opponent2: { id: 20, score: 2, result: "win" },
  },
  {
    id: 20,
    number: 6,
    ...
    status: 0,
    opponent1: { id: 10, score: 0, result: "loss" },
    opponent2: { id: 21, score: 2, result: "win" },
  },
  {
    id: 21,
    number: 7,
  ...
  },
  {
    ...
    child_count: 0,
    status: 0,
    opponent1: { id: 15, result: "loss", score: 1 },
    opponent2: { id: 23, result: "win", score: 2 },
  },
];
...
export const LOWER_BRACKET_R2_MATCHES: Match[] = [
  {
    ...
    child_count: 0,
    status: 0,
    opponent1: { id: 16, result: "loss", score: 1 },
    opponent2: { id: 2, result: "win", score: 2 },
  },
  {
    id: 24,
    number: 2,
    ...
    child_count: 0,
    status: 0,
    opponent1: { id: 5, result: "win", score: 2 },
    opponent2: { id: 19, result: "loss", score: 1 },
  },
  {
    id: 25,
    number: 3,
    ...
    child_count: 0,
    status: 0,
    opponent1: { id: 20, result: "win", score: 2 },
    opponent2: { id: 21, result: "loss", score: 1 },
  },
  {
    id: 26,
    number: 4,
    ...
    child_count: 0,
    status: 0,
    opponent1: { id: 22, result: "win", score: 2 },
    opponent2: { id: 23, result: "loss", score: 0 },
  },
];
...
export const LOWER_BRACKET_R3_MATCHES: Match[] = [
  {
    ...
    child_count: 0,
    status: 0,
    opponent1: { id: 2, result: "win", score: 2 },
    opponent2: { id: 12, result: "loss", score: 0 },
  },
  {
    id: 28,
    number: 2,
    ...
    child_count: 0,
    status: 0,
    opponent1: { id: 5, result: "loss", score: 1 },
    opponent2: { id: 11, result: "win", score: 2 },
  },
  {
    id: 29,
    number: 3,
    ...
    status: 0,
    opponent1: { id: 20, result: "win", score: 2 },
    opponent2: { id: 7, result: "loss", score: 0 },
  },
  {
    id: 30,
    number: 4,
    ...
    status: 0,
    opponent1: { id: 22, result: "win", score: 2 },
    opponent2: { id: 3, result: "loss", score: 0 },
  },
];
...
export const LOWER_BRACKET_R4_MATCHES: Match[] = [
  {
    ...
    status: 0,
    opponent1: { id: 2, result: "win", score: 2 },
    opponent2: { id: 11, result: "loss", score: 0 },
  },
  {
    id: 32,
    number: 2,
    ...
    child_count: 0,
    status: 0,
    opponent1: { id: 20, result: "loss", score: 0 },
    opponent2: { id: 22, result: "win", score: 2 },
  },
];
...
export const LOWER_BRACKET_R5_MATCHES: Match[] = [
  {
    ...
    child_count: 0,
    status: 0,
    opponent1: { id: 2, result: "loss", score: 1 },
    opponent2: { id: 8, result: "win", score: 2 },
  },
  {
    id: 34,
    number: 2,
    ...
    child_count: 0,
    status: 0,
    opponent1: { id: 22, score: 1, result: "loss" },
...
export const LOWER_BRACKET_R6_MATCHES: Match[] = [
  {
    ...
    child_count: 0,
    status: 0,
    opponent1: { id: 8, result: "win", score: 2 },
    opponent2: { id: 4, result: "loss", score: 1 },
  },
];
